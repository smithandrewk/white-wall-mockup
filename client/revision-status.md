...
- [ ] **Ship (pending Drew's go):** swap Acuity Follow-up 1A subject + body to the $100 version + retire the live 75% code (SHAHOUD75) + mint `<lastname>100` going forward. Fast Acuity edit; no repo/code change.
