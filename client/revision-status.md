...
- [ ] **REMAINING VERIFY (next focused money-path pass): full staging booking DRY-RUN** of a multi-day CREW event — confirm booking completes (no regression), the 4h back-end + 2h front-end blocks land on cal `14110701`, notify path runs clean. See SESSION-STATE RESUME HERE.
