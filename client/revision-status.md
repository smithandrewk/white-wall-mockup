...
- [ ] **Item 1a — cleaning-fee net ($110) on Overview + Revenue "Net To Our Bank" — DREW-68 (in progress).** Detector reconciled: 11 cleaning-fee bookings (add-on 6881547 OR "Cleaning fee: $150" in notes), Apr 1 / May 2 / Jun 1 / Jul 4 / Aug 3-to-date (incl. Ryan Clarke today). Internal cost $110/booking; hover note.
- [ ] **Item 1b — Expense Tracker tab + auto Cash Flow "Cleaning Fees" line — DREW-69 (in progress).** Month-by-month cleaning-fee tracking (count / bookings / avg revenue / session type), 2026+; auto fixed line on Cash Flow, month-to-date by received date, resets monthly.
- [ ] **Item 2 — Today's Bookings toggle + clickable Overview tile — DREW-70 (in progress).**
- [ ] **Item 5 — Events as its own top-level tab — DREW-72 (in progress).**
